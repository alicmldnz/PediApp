...
import 'package:pediapp/Widgets/eventwidget.dart';

class MyCalendarPage extends StatefulWidget {
  const MyCalendarPage({super.key, required this.profile});
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            (_events[formatDateTime(_selectedDay)] != null)
                ? SizedBox(
                    width: MediaQuery.of(context).size.width - 32,
                    child: ListView.builder(
                      itemCount:
                          _events[formatDateTime(_selectedDay)]?.length ?? 0,
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: EventWidget(
                            event:
                                _events[formatDateTime(_selectedDay)]![index],
                          ),
                        );
                      },
                    ),
